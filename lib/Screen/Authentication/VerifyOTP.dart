...
class VerifyOtp extends StatefulWidget {
  final String? mobileNumber, countryCode, title, myotp;
...
class _MobileOTPState extends State<VerifyOtp> with TickerProviderStateMixin {
  ...
  void getOtpVerified(){
    if (widget.myotp.toString() == otp.toString()) {
      setSnackbar(getTranslated(context, 'OTPMSG')!);
      Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => SetPass(mobileNumber: mobile!),),);
    }else{
