...
//============================= initState Method ===============================
  ...
  @override
  void initState() {
    print("CUR_USERID______________$CUR_USERID");
...
String? bakery_id;
  ...
  Future<Null> getStatics() async {
    ...
    var parameter = {UserId: CUR_USERID, 'seller_id': bakery_id};
    print("parameter__________${parameter}");
...
//  => Drawer Header
  ...
  getImage() async{
    ...
    print("get_usersApi_url_is__ ${get_usersApi} & params___ $params");

    final response = await http.post(get_usersApi, body: params);
    ...
    if (jsonResponse['error'] == false){
      user_image = jsonResponse['data'][0]['image'];
      print("response_is_______________${jsonResponse['data']} user_image_____  $user_image");
    }else{
        ...
        child: Row(
          children: [
            ...
            Container(
              ...
              child: user_image != '' || user_image != null
                  ? ClipRRect(
                borderRadius: BorderRadius.circular(100),
                child: Image.network('$user_image', fit: BoxFit.fill,),
              )
                  : ClipRRect(
          ...
          apiBaseHelper.postAPICall(getOrdersApi, parameter).then(
              ...
              if (!error) {
                ...
                if (data.length != 0) {
                  ...
                  print("checking list here ${orderList}");
                  scrollLoadmore = true;
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    model.itemList![0].storeName =="" || model.itemList![0].storeName == null ?Text("NA"):
                    Container(
                      alignment: Alignment.centerRight,
                      width: MediaQuery.of(context).size.width / 2,
                      child: Text("${model.itemList![0].storeName}"),
                    ),
                  ],
                ),
              ),
