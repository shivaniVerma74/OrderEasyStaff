...
//========================= getDeliveryBoy API =================================
      ...
      (getdata) async {
        ...
        if (!error) {
          ...
          delBoyList = (data as List)
              ...
              .toList();
          // print("delivery boys ${delBoyList.length}");
        } else {
          setSnackbar(msg!);
        }
      },
  ...
  Future<Null> getOrderDetail() async {
    ...
    if (_isNetworkAvail) {
      ...
      print("get oredre parraa ${parameter}");
  ...
  Widget build(BuildContext context) {
    print("widget id here ${widget.id}");
                  ...
                  Flexible(
                    child: SingleChildScrollView(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: () {
                          print("search list here ${searchList.length}");
                          return searchList
                              .asMap()
                              .map(
                                  ...
                                  InkWell(
                                    onTap: () {
                                      ...
                                      if (mounted) {
                                        ...
                                        print("selected boy ${selectedDelBoy}");
                                      }
                                    },
                                    child: Container(
...
//============================ Select Delivery Boy =============================
                        ...
                        //                           child: Text(
                        //                             index1 != -1
                        //                                 ? orderItem.deliveryBoyName! : getTranslated(
                        //                               context,
                        //                               "SELECTDELBOY",
                        //                             )!,
                        //                             maxLines: 1,
