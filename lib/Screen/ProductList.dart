...
import 'package:eshopmultivendor/editScreen.dart';
...
class StateProduct extends State<ProductList> with TickerProviderStateMixin {
  ...
  Widget listItem(int index) {
    if (index < productList.length) {
      ...
      items = new List<String>.generate(model.totalAllow != null ? int.parse(model.totalAllow!) : 10,
          (i) => (i + 1).toString());
          ...
          child: Stack(children: <Widget>[
            Padding(
              ...
              child: Row(
                ...
                children: <Widget>[
                  if(model.image != null || model.image != '' || model.image != 'https://developmentalphawizz.com/mt/')
                  Hero(
                    tag: "$index${model.id}",
                    child: ClipRRect(
                        ...
                        children: <Widget>[
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              InkWell(
                                onTap: () {
                                  Navigator.push(context, MaterialPageRoute(builder: (context)=>AddProduct(isEdit: true, model: model)));
                                },
                                child: Card(
                                  child: Icon(
                                    Icons.edit,
  ...
  delProductApi(String id) async {
    ...
    if (_isNetworkAvail) {
      ...
      apiBaseHelper.postAPICall(getDeleteProduct, parameter).then(
        (getdata) {
          bool error = getdata["error"];
          String? msg = getdata["message"];
          if (!error) {
