...
//============================= Init method ====================================
  ...
  getImage() async{
    ...
    if (jsonResponse['error'] == false){
      ...
      log("response_is_______________${jsonResponse['data']} user_image_____  $user_image");
    }else{
                    ...
                    child: GestureDetector(
                      ...
                      child: Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              color: primary),
                          child: (selectedimage == null || selectedimage == "") && (user_image == "" || user_image == null)
                              ? Icon(
                            Icons.camera_alt,
                            color: white,
                            size: 30,
                          ) :
                          (selectedimage == null || selectedimage == "") && (user_image != "" || user_image != null)?
                          Container(
                            height: 150,
                            width: 150,
                            decoration: BoxDecoration(
...
//==================== Same API But Only PassPassword ==========================
  ...
  //     };
  //
  //     print("parameter_______$parameter");
  //     apiBaseHelper.postAPICall(updateUserApi, parameter).then(
  //       (getdata) async {
  //         bool error = getdata["error"];
  //         String? msg = getdata["message"];
  ...
  editProfileApi() async{
    ...
    var request = await http.MultipartRequest("POST", updateUserApi);
    ...
    print("updateUserApi_params___ ${request.fields} image___ ${request.files} url_is__ ${updateUserApi}");
    ...
    if (jsonResponse['error'] == false) {
      ...
      selectedimage = '';
      Navigator.pop(context);
      print("updateUserApi_response_is_______ ${jsonResponse}");
    } else {
      Navigator.pop(context);
      toast("${jsonResponse['message']}");
    }
